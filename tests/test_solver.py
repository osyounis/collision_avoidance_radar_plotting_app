...
def test_solve_head_on_scenario():
    ...
    problem = RadarProblem(
        ...
        m_point=RadarPoint(3.0, 7.0, "10:10")       # Target closer, still nearly ahead (second pip)
    )
...
def test_solve_with_different_time_intervals():
    ...
    expected_distance_traveled = problem.our_speed * time_delta_hours     # 10 kts x 0.05hr = 0.5 NM
